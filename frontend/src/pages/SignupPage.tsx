    ...
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center relative overflow-hidden py-12">
      ...
      <div className="w-full max-w-[420px] mx-4">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex w-11 h-11 bg-white text-black rounded-xl items-center justify-center font-bold text-xl shadow-xl shadow-white/10 mb-5 mx-auto">
            N
          </div>
